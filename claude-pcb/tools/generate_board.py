...
def silk_labels(b):
    labels = [
        ...
        ("24V IN", 60, 12.5, 1.3),
        ("LED", 13, 38, 1.3),
        ("COIL", 113, 37, 1.3), ("AUX", 113, 59, 1.3),
        ("PANEL", 14, 71, 1.2), ("DOOR", 38, 71, 1.2),
        ("BENCH", 54, 71, 1.2), ("CEILING", 78, 71, 1.2),
        ("SRL250", 100, 71, 1.2),
        ("FUSES  F1=LED 5A  F2=COIL 1A  F3=LOGIC 1A", 70, 37, 1.0),
        ("ANTENNA KEEPOUT", 9, 55, 1.0),
        (f"{TITLE}  REV {REV}", 44, 41, 1.4),
        ("<- USB", 76, 44, 1.0),
        ("AUX CLOSED = ON", 112, 62.5, 0.9),
        # J_PWR (top edge), labels above pin row
        ("+24V", 60, 2.5, 0.8), ("0V", 65.1, 2.5, 0.8),
        # J_LED (left edge), labels to the right of the vertical pin column
        ("R-", 10, 13, 0.8), ("G-", 10, 18.1, 0.8), ("B-", 10, 23.2, 0.8),
        ("W-", 10, 28.2, 0.8), ("V+", 10, 33.3, 0.8),
        # J_COIL (right edge), labels left of the vertical pin column
        ("C-", 118.5, 24.9, 0.8), ("C+", 118.5, 30, 0.8),
        # J_AUX (right edge)
        ("AUX", 118, 46.9, 0.8), ("+24", 118, 52, 0.8),
        # Bottom edge connectors (below pin row, y ~ 82.5)
        ("5V", 16, 82.5, 0.8), ("0V", 21.1, 82.5, 0.8),
        ("TX", 26.2, 82.5, 0.8), ("RX", 31.2, 82.5, 0.8),
        ("DOOR", 40, 82.5, 0.8), ("0V", 45.1, 82.5, 0.8),
        ("3V3", 56, 82.5, 0.8), ("DAT", 61.1, 82.5, 0.8),
        ("0V", 66.2, 82.5, 0.8),
        ("3V3", 80, 82.5, 0.8), ("DAT", 85.1, 82.5, 0.8),
        ("0V", 90.2, 82.5, 0.8),
        ("OUT", 104, 82.5, 0.8), ("RTN", 109.1, 82.5, 0.8),
    ]
