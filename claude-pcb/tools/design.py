...
#   RIGHT edge  : J_COIL, J_AUX  (land right next to the contactor)
...
add("R8", "R", "R_0805", "100R", (22, 26.5, 90),
    {1: "GPIO19", 2: "G_R"}, (144, 150))
add("R9", "R", "R_0805", "100R", (31, 26.5, 90),
    {1: "GPIO18", 2: "G_G"}, (164, 150))
add("R10", "R", "R_0805", "100R", (40, 26.5, 90),
    {1: "GPIO17", 2: "G_B"}, (184, 150))
add("R11", "R", "R_0805", "100R", (49, 26.5, 90),
    {1: "GPIO16", 2: "G_W"}, (204, 150))
add("R13", "R", "R_0805", "10K", (22, 30.5, 90),
    {1: "G_R", 2: "GND"}, (156, 150))
add("R14", "R", "R_0805", "10K", (31, 30.5, 90),
    {1: "G_G", 2: "GND"}, (176, 150))
add("R15", "R", "R_0805", "10K", (40, 30.5, 90),
    {1: "G_B", 2: "GND"}, (196, 150))
add("R16", "R", "R_0805", "10K", (49, 30.5, 90),
    {1: "G_W", 2: "GND"}, (216, 150))

# --- Opto-isolated 24 V inputs (LTV-817: 1=A 2=K 3=E 4=C) -------------------
# All three optos cluster right-center, near J_AUX / J_SRL250 / J_SPARE.
# AUX channel (input from J_AUX).
add("R1", "R", "R_1206", "3K3 1W", (116, 44, 0),
    {1: "AUX_IN", 2: "AUX_LED"}, (126, 76))
add("D2", "TVS", "D_SMB", "SMBJ30CA", (116, 39, 90),
    {1: "GND", 2: "AUX_IN"}, (126, 90), MPN="SMBJ30CA")
add("D9", "D", "D_SOD323", "1N4148WS", (112, 46, 0),
    {1: "AUX_LED", 2: "GND"}, (132, 90))
add("OPT1", "OPTO", "DIP4", "LTV-817", (105, 48, 0),
    {1: "AUX_LED", 2: "GND", 3: "GND", 4: "GPIO32"}, (150, 80),
    MPN="LTV-817")
add("R4", "R", "R_0805", "10K", (99, 53, 0),
    {1: "+3V3", 2: "GPIO32"}, (162, 70))
# High-limit channel: senses 24 V presence on SRL250_RTN (post-high-limit).
add("R2", "R", "R_1206", "3K3 1W", (116, 62, 0),
    {1: "SRL250_RTN", 2: "HL_LED"}, (126, 110))
add("D3", "TVS", "D_SMB", "SMBJ30CA", (116, 67, 90),
    {1: "GND", 2: "SRL250_RTN"}, (126, 124), MPN="SMBJ30CA")
add("D10", "D", "D_SOD323", "1N4148WS", (112, 64, 0),
    {1: "HL_LED", 2: "GND"}, (132, 124))
add("OPT2", "OPTO", "DIP4", "LTV-817", (105, 66, 0),
    {1: "HL_LED", 2: "GND", 3: "GND", 4: "GPIO33"}, (150, 110),
    MPN="LTV-817")
add("R5", "R", "R_0805", "10K", (99, 71, 0),
    {1: "+3V3", 2: "GPIO33"}, (162, 100))
# Spare channel (GPIO25, matches commented-out firmware block).
add("R3", "R", "R_1206", "3K3 1W", (88, 57, 0),
    {1: "SPARE_IN", 2: "SPARE_LED"}, (126, 140))
add("D4", "TVS", "D_SMB", "SMBJ30CA", (88, 63, 90),
    {1: "GND", 2: "SPARE_IN"}, (126, 154), MPN="SMBJ30CA")
add("D11", "D", "D_SOD323", "1N4148WS", (75, 57, 0),
    {1: "SPARE_LED", 2: "GND"}, (132, 154))
add("OPT3", "OPTO", "DIP4", "LTV-817", (81, 60, 0),
    {1: "SPARE_LED", 2: "GND", 3: "GND", 4: "GPIO25"}, (150, 140),
    MPN="LTV-817")
add("R6", "R", "R_0805", "10K", (75, 63, 0),
    {1: "+3V3", 2: "GPIO25"}, (162, 130))

# --- Door input (bottom band, above J_DOOR) ---------------------------------
add("D6", "ESD", "D_SOD923", "ESD9B5.0", (37, 73, 0),
    {1: "DOOR_IN", 2: "GND"}, (276, 80), MPN="ESD9B5.0ST5G")
add("R18", "R", "R_0805", "1K", (41, 73, 0),
    {1: "DOOR_IN", 2: "GPIO22"}, (282, 76))
add("C9", "C", "C_0805", "100nF", (45, 73, 0),
    {1: "GPIO22", 2: "GND"}, (288, 86))
add("R17", "R", "R_0805", "10K", (49, 73, 0),
    {1: "+3V3", 2: "GPIO22"}, (294, 70))

# --- DS18B20 1-Wire (bottom band, above J_BENCH / J_CEILING) ----------------
add("R19", "R", "R_0805", "4K7", (53, 73, 0),
    {1: "+3V3", 2: "BENCH_DATA"}, (276, 106))
add("R21", "R", "R_0805", "100R", (57, 73, 0),
    {1: "BENCH_DATA", 2: "GPIO26"}, (282, 110))
add("D7", "ESD", "D_SOD923", "ESD9B5.0", (61, 73, 0),
...
add("U2", "USBLC6", "SOT23_6", "USBLC6-2SC6", (46, 56, 0),
    {1: "PANEL_TX", 2: "GND", 3: "PANEL_RX",
     4: "PANEL_RX", 5: "+3V3", 6: "PANEL_TX"}, (240, 70),
    MPN="USBLC6-2SC6")
add("R23", "R", "R_0805", "100R", (40, 53, 0),
    {1: "GPIO14", 2: "PANEL_TX"}, (228, 60))
add("R24", "R", "R_0805", "100R", (52, 53, 0),
    {1: "PANEL_RX", 2: "GPIO4"}, (228, 66))

# --- Indicators (top-right corner, above J_COIL) ----------------------------
add("R25", "R", "R_0805", "10K", (104, 7, 0),
    {1: "+24V_LOGIC", 2: "LED24_A"}, (22, 130))
add("LED1", "LED", "LED_0805", "GREEN 24V", (109, 7, 0),
    {1: "LED24_A", 2: "GND"}, (22, 140))
add("R26", "R", "R_0805", "1K", (104, 11, 0),
    {1: "+5V", 2: "LED5_A"}, (40, 130))
add("LED2", "LED", "LED_0805", "GREEN 5V", (109, 11, 0),
    {1: "LED5_A", 2: "GND"}, (40, 140))
add("R27", "R", "R_0805", "1K", (104, 15, 0),
    {1: "GPIO23", 2: "FAULT_A"}, (58, 130))
add("LED3", "LED", "LED_0805", "RED FAULT", (109, 15, 0),
...
# --- Test points -------------------------------------------------------------
_tps = [("TP1", "+24V", (56, 13)), ("TP2", "+5V", (94, 52)),
        ("TP3", "+3V3", (40, 64)), ("TP4", "GND", (45, 12)),
        ("TP5", "LED_R-", (20, 4.5)), ("TP6", "LED_G-", (29, 4.5)),
        ("TP7", "LED_B-", (38, 4.5)), ("TP8", "LED_W-", (47, 4.5)),
        ("TP9", "COIL-", (118, 34)), ("TP10", "GPIO32", (95, 48)),
        ("TP11", "GPIO33", (95, 66)), ("TP12", "GPIO22", (54, 64)),
        ("TP13", "PANEL_TX", (40, 49)), ("TP14", "PANEL_RX", (54, 58)),
        ("TP15", "AUX_LED", (111, 42))]
