...
FOOTPRINTS = {
    ...
    # 5x20 fuse holder, Keystone 3517-class, top access. VERIFY before order.
    "FUSE_5x20": dict(pads=[("1", "thru_hole", "rect", (0, 0), (3.2, 3.2), 1.5),
                            ("2", "thru_hole", "circle", (22.6, 0), (3.2, 3.2), 1.5)],
                      courtyard=(-2.5, -4.2, 25.1, 4.2)),
